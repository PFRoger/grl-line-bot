...
async function submitOrder(userId, displayName, cartItems, buyerInfo, discountInfo = {}) {
  ...
  // 從 append 回應解析剛寫入的行號（updatedRange 形如 "訂單!A8:P8"）
  ...
  return { orderId, orderTime, totalTwd, discountTotal, finalAmount, pointsUsed: pointsUsed || 0, couponCode: couponCode || '', couponAmount: couponAmount || 0, rowNum };
}
